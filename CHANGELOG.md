# [5.3.0](https://github.com/Flat/revanced-patches/compare/v5.2.0...v5.3.0) (2025-01-15)


### Bug Fixes

* **Change package name:** Prevent applying the patch to known incompatible apps ([#3943](https://github.com/Flat/revanced-patches/issues/3943)) ([44936e7](https://github.com/Flat/revanced-patches/commit/44936e71e846f72f7279950232a5dba37765ceb3))
* **ci:** update url for publishing ([a08568b](https://github.com/Flat/revanced-patches/commit/a08568b5e26e0eb2a4ba3db378368a7bd23436a7))
* **GmsCore support:** Adjust presentation of battery optimization dialog  ([#4091](https://github.com/Flat/revanced-patches/issues/4091)) ([5d8fc1b](https://github.com/Flat/revanced-patches/commit/5d8fc1bcd4e453298cfac086cdbdf279612bfb63))
* **GmsCore support:** Do not show battery optimization error on Android Automotive devices (Google built-in) ([#4218](https://github.com/Flat/revanced-patches/issues/4218)) ([d6e389c](https://github.com/Flat/revanced-patches/commit/d6e389cc43bc40724f032b230f70048276349a19))
* **Reddit:** Fix patches by using correct extension class ([70bdc68](https://github.com/Flat/revanced-patches/commit/70bdc6840d465399625aa1ae0259f49e72711955))
* **Sync for Reddit:** Fix patches by using correct extension name ([030093e](https://github.com/Flat/revanced-patches/commit/030093e913aab3fab43935eedbaeba0f6c0491bb))
* **TikTok - Settings:** Use correct colors for dark mode ([#4087](https://github.com/Flat/revanced-patches/issues/4087)) ([6bd22ff](https://github.com/Flat/revanced-patches/commit/6bd22ffa7e8af4d8f5d2d3b1711bd92c44b4e4aa))
* **TikTok - SIM Spoof:** Change patch to default off to fix login ([#4084](https://github.com/Flat/revanced-patches/issues/4084)) ([f4659a3](https://github.com/Flat/revanced-patches/commit/f4659a328eaf600e1e5f02a66fa2af4b6d8dc7c1))
* **Twitch:** Change recommended target to the latest app version ([fb32972](https://github.com/Flat/revanced-patches/commit/fb32972f4de92dac1fc5d73f56a392a671c4e94b))
* **Twitch:** Resolve setting menu crashes ([#4025](https://github.com/Flat/revanced-patches/issues/4025)) ([62df596](https://github.com/Flat/revanced-patches/commit/62df5965d7331e47b3143425d169a79a19eac447))
* **Twitter - Change link sharing domain:** Use correct extension package ([ad7fab6](https://github.com/Flat/revanced-patches/commit/ad7fab67319ba23f267d27da9b74266965fc4be3))
* **twitter:** doubleclick ads ([c32fe2e](https://github.com/Flat/revanced-patches/commit/c32fe2efbe7824ea503ed12c4d1bd0d9a12991ac))
* **Twitter:** Merge correct extension by depending on correct extension patch ([8281cf6](https://github.com/Flat/revanced-patches/commit/8281cf6a3eead8cc25a277371e0b0ab2be982497))
* **YouTube - Exit fullscreen mode:** Exit fullscreen mode of first video opened after cold start ([be5cf2e](https://github.com/Flat/revanced-patches/commit/be5cf2e834d87d51b5d3061d46bd7154d6306787))
* **YouTube - Force original audio:** If stream spoofing to Android then show a summary text why force audio is not available ([#4220](https://github.com/Flat/revanced-patches/issues/4220)) ([029aee8](https://github.com/Flat/revanced-patches/commit/029aee8023f096413fc80a2c583b4fe55ecb10ac))
* **YouTube - Force original audio:** Use correct availability for settings UI ([a7eedcb](https://github.com/Flat/revanced-patches/commit/a7eedcb4cca6b7b12629c478c24c0899c80e3615))
* **YouTube - Force original audio:** Use correct original audio stream if app language is not English ([0d20171](https://github.com/Flat/revanced-patches/commit/0d2017133efac230887b5c2a331d87159df8af11))
* **YouTube - Hide ads:** Hide new type of featured promotions ([#4113](https://github.com/Flat/revanced-patches/issues/4113)) ([13c7592](https://github.com/Flat/revanced-patches/commit/13c7592b21defd27e3a7aa9b219ffc0247bb5914))
* **YouTube - Hide layout components:** Don't hide Shorts channel bar when toggling for video player ([9af6412](https://github.com/Flat/revanced-patches/commit/9af6412d92ec31e612eaabba6578453da0fc61d6))
* **YouTube - Hide layout components:** Hide new kind of community post ([#4155](https://github.com/Flat/revanced-patches/issues/4155)) ([08f68cb](https://github.com/Flat/revanced-patches/commit/08f68cb5d33f2cfe656d2f93d159c69981f31418))
* **YouTube - Miniplayer:** Use estimated maximum on screen size for devices with low density screens ([#4150](https://github.com/Flat/revanced-patches/issues/4150)) ([2694158](https://github.com/Flat/revanced-patches/commit/2694158c3c9935ede21c96832533222f850068df))
* **YouTube - Open Shorts in regular player:** Do not show the miniplayer after opening a Short while a video is playing ([894e366](https://github.com/Flat/revanced-patches/commit/894e36665d17d5a3a5728961d424dffc55faa50b))
* **YouTube - SponsorBlock:** Show a toast and not a dialog if segment submitted successfully ([134b189](https://github.com/Flat/revanced-patches/commit/134b189791113dcf1a1cb7c87b8a0954f432730c))
* **YouTube - SponsorBlock:** Show create new segment error messages using a dialog ([#4148](https://github.com/Flat/revanced-patches/issues/4148)) ([5870906](https://github.com/Flat/revanced-patches/commit/587090636dfff0b358b15026cf7d47c65a4296dc))
* **YouTube - Spoof app version:** Update spoof target to resolve library tab crashes ([#4014](https://github.com/Flat/revanced-patches/issues/4014)) ([c8eced5](https://github.com/Flat/revanced-patches/commit/c8eced54704017df4e91e536dbef1e9514306f67))
* **YouTube - Spoof app version:** Update spoof target to resolve library tab crashes ([#4019](https://github.com/Flat/revanced-patches/issues/4019)) ([d89ad65](https://github.com/Flat/revanced-patches/commit/d89ad6501a7cdb3c074c6204dac7960ca3e252f1))
* **YouTube - Spoof video stream:** Remove UI client type setting.  Allow setting default audio language. ([#4184](https://github.com/Flat/revanced-patches/issues/4184)) ([99f3f29](https://github.com/Flat/revanced-patches/commit/99f3f29c649bf7693c05bbce2bb49bd53e05f050))
* **YouTube - Spoof video streams:** Add 'Android Creator' ([#4262](https://github.com/Flat/revanced-patches/issues/4262)) ([0479dd2](https://github.com/Flat/revanced-patches/commit/0479dd265e09b0accdf6ff6b00c8e938dc5b96c7))
* **YouTube - Spoof video streams:** Add iOS TV client, restore iOS 'force AVC', show client type in stats for nerds ([#4202](https://github.com/Flat/revanced-patches/issues/4202)) ([ab29f80](https://github.com/Flat/revanced-patches/commit/ab29f808a9f55b5ab0055533c1a6de549b0631a6))
* **YouTube - Spoof video streams:** Add missing preferred language preference to the settings ([630633c](https://github.com/Flat/revanced-patches/commit/630633cf57c65c65e5578046413e17670ae336e8))
* **YouTube - Spoof video streams:** Change default spoofing to iOS, allow setting a default language with Android VR ([#4171](https://github.com/Flat/revanced-patches/issues/4171)) ([171b4e7](https://github.com/Flat/revanced-patches/commit/171b4e7e40066e38fba773b7a6525e9a038779ef))
* **YouTube - Spoof video streams:** Enable opus codec by updating iOS client version ([#4063](https://github.com/Flat/revanced-patches/issues/4063)) ([0af156f](https://github.com/Flat/revanced-patches/commit/0af156f18972c5f089af4bb69824968d2a47d18f))
* **YouTube - Spoof video streams:** Fix error toast that is sometimes shown ([#4090](https://github.com/Flat/revanced-patches/issues/4090)) ([4c46cb2](https://github.com/Flat/revanced-patches/commit/4c46cb27a02c6f29626cd769b6a8e825645d5b16))
* **YouTube - Spoof video streams:** Ignore harmless error toast if hide ads is disabled ([c3423bb](https://github.com/Flat/revanced-patches/commit/c3423bb9e531cfa52f6d28e0b98bbe8ab8684c30))
* **YouTube - Spoof video streams:** Make livestreams start at the current time when using iOS client   ([#4137](https://github.com/Flat/revanced-patches/issues/4137)) ([140f484](https://github.com/Flat/revanced-patches/commit/140f484b4b251b0dfa94163a63f61f45f5302052))
* **YouTube - Spoof video streams:** Remove iOS, add clients Android TV and Android Creator ([#4180](https://github.com/Flat/revanced-patches/issues/4180)) ([86abfb2](https://github.com/Flat/revanced-patches/commit/86abfb2b0d4675f0a1cb9ab244783075bfe89281))
* **YouTube - Spoof video streams:** Resolve playback of age restricted videos ([#4096](https://github.com/Flat/revanced-patches/issues/4096)) ([839a404](https://github.com/Flat/revanced-patches/commit/839a4045f1bb1759d89047834e0b7695781e82a3))
* **YouTube - Spoof video streams:** Update `Force AVC` client data ([#4064](https://github.com/Flat/revanced-patches/issues/4064)) ([7d537dd](https://github.com/Flat/revanced-patches/commit/7d537ddff4bb5421fa320741275131a66ef5c7bb))
* **YouTube - Spoof video streams:** Update iOS client version ([df3aeed](https://github.com/Flat/revanced-patches/commit/df3aeed3b173e408fad80197a89ec5d003a2b328))
* **YouTube - Spoof video streams:** Use 2 letter device language code ([33ff997](https://github.com/Flat/revanced-patches/commit/33ff9972000581aca92262f984efb114eeeb9537))
* **YouTube - Spoof video streams:** Use Android VR authentication if using default audio language ([#4191](https://github.com/Flat/revanced-patches/issues/4191)) ([98773cc](https://github.com/Flat/revanced-patches/commit/98773cc7d46e5c9c7715b82c8006f1ccbcc5443c))
* **YouTube - Spoof video streams:** Use system language as default iOS audio stream ([#4042](https://github.com/Flat/revanced-patches/issues/4042)) ([4017185](https://github.com/Flat/revanced-patches/commit/4017185e760c0569e6644b94bbe66a84fa245b4b))
* **YouTube - Theme:** Use dark theme color for status and navigation bar ([0240efe](https://github.com/Flat/revanced-patches/commit/0240efe33e5444625ca2b760c861c9046d3dc836))
* **YouTube Music - Bypass certificate checks:** Add a recommended target version ([#4104](https://github.com/Flat/revanced-patches/issues/4104)) ([17a5a6c](https://github.com/Flat/revanced-patches/commit/17a5a6c1691b0c23f601d3355b72f122c2bd5dcb))
* **YouTube Music - GmsCore support:** Resolve patching errors ([#4056](https://github.com/Flat/revanced-patches/issues/4056)) ([38a4bad](https://github.com/Flat/revanced-patches/commit/38a4bad5b890e3906d77d22efeabd8f38653508b))
* **YouTube Music - Hide category bar:** Add support for latest release ([#3968](https://github.com/Flat/revanced-patches/issues/3968)) ([b63fdeb](https://github.com/Flat/revanced-patches/commit/b63fdeb10b504468307a77bd5de69407906848bf))
* **YouTube Music - Permanent shuffle:** Remove obsolete and non functional patch ([#4073](https://github.com/Flat/revanced-patches/issues/4073)) ([fbc6ab6](https://github.com/Flat/revanced-patches/commit/fbc6ab6a357b351f02d4d486ddc2072cf53199c3))
* **YouTube Music - Spoof video streams:** Disable stable volume ([#4097](https://github.com/Flat/revanced-patches/issues/4097)) ([16bb9df](https://github.com/Flat/revanced-patches/commit/16bb9dfc299612f3922724c136878606987ab132))
* **YouTube Music:** Add `Spoof client patch` to fix playback ([#4132](https://github.com/Flat/revanced-patches/issues/4132)) ([b092508](https://github.com/Flat/revanced-patches/commit/b0925088e8b41636e285cb234593d545604ce461))
* **YouTube:** Change fingerprints to support a wider range of target versions ([8a09174](https://github.com/Flat/revanced-patches/commit/8a09174def205a26ce49cb7815097e235069526a))
* **YouTube:** Do not reset playback speed to 1.0x after closing comment thread (Fixes stock YouTube bug) ([#4195](https://github.com/Flat/revanced-patches/issues/4195)) ([dda788c](https://github.com/Flat/revanced-patches/commit/dda788c58c789d4f91646ea8e8a8077f590ab6b3))
* **YouTube:** Fix string translations ([52e04d3](https://github.com/Flat/revanced-patches/commit/52e04d340c1a85f3d683c67a15ae96529432d5fe))


### Features

* Add Internal data documents provider patch ([#3830](https://github.com/Flat/revanced-patches/issues/3830)) ([cb22f65](https://github.com/Flat/revanced-patches/commit/cb22f652ed678d81ffda9ece659b3971225d6931))
* **Change package name:** Add options to change provider and permission package names to handle installation conflicts ([75c740c](https://github.com/Flat/revanced-patches/commit/75c740c6ba2e0c62e567f7dc90cdad368fc4f372))
* **Nyx:** Remove broken `Unlock pro` patch ([1fe8b16](https://github.com/Flat/revanced-patches/commit/1fe8b164eab0c4fa80ab2da2581977f5111a2858))
* **Swipe controls:** Add option to enable/disable fullscreen swipe to next video ([#4222](https://github.com/Flat/revanced-patches/issues/4222)) ([119092f](https://github.com/Flat/revanced-patches/commit/119092fafa4129849246df15fe8076ed3b491b85))
* **Twitch:** Make patches compatible with latest versions ([#4099](https://github.com/Flat/revanced-patches/issues/4099)) ([eecfbb7](https://github.com/Flat/revanced-patches/commit/eecfbb7122a9072e55e687f2c003f63108654888))
* **YouTube - Comments:** Add `Hide 'Chat summary'` ([#4110](https://github.com/Flat/revanced-patches/issues/4110)) ([269493c](https://github.com/Flat/revanced-patches/commit/269493cd198604f1438ea2850fb68fe900d0e56f))
* **YouTube - Hide feed components:** Remove obsolete `Hide search result shelf header` option ([#4134](https://github.com/Flat/revanced-patches/issues/4134)) ([c71443a](https://github.com/Flat/revanced-patches/commit/c71443a08883ab10ef2553213c03b00e7c580a43))
* **YouTube - Hide Shorts components:** Add option to hide Shorts in watch history ([#4214](https://github.com/Flat/revanced-patches/issues/4214)) ([19c2742](https://github.com/Flat/revanced-patches/commit/19c2742aa367367c77bb50ddad6f8a20fef8ea0a))
* **YouTube - Navigation buttons:** Add options to disable translucent status bar and navigation bar ([#4133](https://github.com/Flat/revanced-patches/issues/4133)) ([a2d2141](https://github.com/Flat/revanced-patches/commit/a2d2141cec9b0b4929e07a8010889b21c324b229))
* **YouTube - Spoof app version:** Add 'Restore old navigation and toolbar icons' ([f84e459](https://github.com/Flat/revanced-patches/commit/f84e459d3d54b3001586796ab4e114ebadf09043))
* **YouTube - Spoof video streams:** Allow picking a default audio language track ([#4050](https://github.com/Flat/revanced-patches/issues/4050)) ([ede666b](https://github.com/Flat/revanced-patches/commit/ede666b5cb64fcbaa1334ad8bef79e2634ced113))
* **YouTube Music:** Add `Spoof video streams` patch to fix playback ([#4065](https://github.com/Flat/revanced-patches/issues/4065)) ([cf3116a](https://github.com/Flat/revanced-patches/commit/cf3116a7583d09c25c798a85687a056f143656f0))
* **YouTube:** Add `Change form factor` patch ([#4217](https://github.com/Flat/revanced-patches/issues/4217)) ([644ac5b](https://github.com/Flat/revanced-patches/commit/644ac5baa68b209a32300149a2efa009b776f9a7))
* **YouTube:** Add `Exit fullscreen mode` patch ([#4223](https://github.com/Flat/revanced-patches/issues/4223)) ([bb5d03b](https://github.com/Flat/revanced-patches/commit/bb5d03bd89a3f932c77e4e9de90174c374933688))
* **YouTube:** Add `Force original audio` patch ([#4122](https://github.com/Flat/revanced-patches/issues/4122)) ([f4aa440](https://github.com/Flat/revanced-patches/commit/f4aa4406080b91f01d623e54b11b99ea849ddcdf))
* **YouTube:** Add `Open Shorts in regular player` patch ([#4153](https://github.com/Flat/revanced-patches/issues/4153)) ([c7c5e5b](https://github.com/Flat/revanced-patches/commit/c7c5e5b2b9cf63d8225bb6bd5e735ddf945b6c29))
* **YouTube:** Add `Open videos fullscreen` patch ([#4069](https://github.com/Flat/revanced-patches/issues/4069)) ([296d63b](https://github.com/Flat/revanced-patches/commit/296d63bd42c338a01efbcb2df702e5822d05a5f1))
* **YouTube:** Add in app option to select a preferred language for ReVanced specific text ([#4231](https://github.com/Flat/revanced-patches/issues/4231)) ([3932af3](https://github.com/Flat/revanced-patches/commit/3932af397ae89a0b30191cd870bd6cddb7a078db))
* **YouTube:** Support version `19.47.53` ([#4182](https://github.com/Flat/revanced-patches/issues/4182)) ([2089e61](https://github.com/Flat/revanced-patches/commit/2089e613d36c45352db7d852aaee0087b1c3e1a4))


### Performance Improvements

* Move variables to local scope ([43c0421](https://github.com/Flat/revanced-patches/commit/43c04216c6e647eaf6ad7e813eb5f0df0c108b77))
